...
export const TOURISM_CATEGORIES = {
  ...
  karabakh: { emoji: "⛰️", label: "Qarabağ", cities: ["Ağdam", "Füzuli", "Laçın", "Kəlbəcər"] },
  nakhchivan: { emoji: "🏜️", label: "Naxçıvan", cities: ["Naxçıvan", "Ordubad", "Şahbuz"] },
};
...
export const CITIES: City[] = [
  ...
  },
  {
    ...
    touristPlaces: [
      ...
      { name: "Qız Qalası", description: "XII əsrdən qalan sirli qala qülləsi, möhtəşəm panoramik mənzərə.", price: "8 AZN", rating: 4.7, image: "https://images.unsplash.com/photo-1524661135-423995f22d0b?w=400&h=250&fit=crop" },
  ...
  },
  {
    ...
    lat: 39.99, lng: 46.93,
    region: "Qarabağ",
    tagline: "Qarabağın dirçələn şəhəri",
    heroColor: "#D35400",
    tourismCategory: "karabakh",
    touristPlaces: [
      { name: "Ağdam Cümə Məscidi", description: "Tarixi məscid, şəhərin simvol yerlərindən biri.", price: "Pulsuz", rating: 4.7, image: "https://images.unsplash.com/photo-1585036156171-384164a8c821?w=400&h=250&fit=crop" },
      { name: "Ağdam şəhər panoraması", description: "Şəhərə baxış nöqtələri və foto üçün uyğun yerlər.", price: "Pulsuz", rating: 4.4, image: "https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=400&h=250&fit=crop" },
      { name: "Ağdam Tarix guşəsi", description: "Şəhərin keçmişi və mədəniyyəti barədə məlumat lövhələri.", price: "Pulsuz", rating: 4.2, image: "https://images.unsplash.com/photo-1518998053901-5348d3961a04?w=400&h=250&fit=crop" },
      { name: "Şəhidlər xatirə guşəsi", description: "Xatirə məkanı və sakit gəzinti üçün ərazi.", price: "Pulsuz", rating: 4.3, image: "https://images.unsplash.com/photo-1505761671935-60b3a7427bad?w=400&h=250&fit=crop" },
      { name: "Ağdam bazar ərazisi", description: "Yerli məhsullar və suvenir axtarışı üçün məkan.", price: "Pulsuz", rating: 4.1, image: "https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=400&h=250&fit=crop" },
    ],
    restaurants: [
      { name: "Ağdam Kabab Evi", cuisine: "Kabab/Milli", priceRange: "12–25 AZN", rating: 4.3, image: "https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=400&h=250&fit=crop" },
      { name: "Qarabağ Mətbəxi", cuisine: "Azərbaycan", priceRange: "15–30 AZN", rating: 4.4, image: "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=400&h=250&fit=crop" },
    ],
    hotels: [
      { name: "Ağdam City Hotel", priceRange: "60–120 AZN/gecə", rating: 4.2, image: "https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?w=400&h=250&fit=crop" },
      { name: "Ağdam Guest House", priceRange: "25–55 AZN/gecə", rating: 4.0, image: "https://images.unsplash.com/photo-1571003123894-1f0594d2b5d9?w=400&h=250&fit=crop" },
    ],
    plans: [
      { days: 3, price: "5 AZN", dailyPlans: [
        { day: 1, activities: [{ name: "Ağdam Cümə Məscidi", type: "tourist", price: "Pulsuz" }] },
        { day: 2, activities: [{ name: "Şəhər panoraması", type: "activity", price: "Pulsuz" }, { name: "Ağdam Kabab Evi", type: "restaurant", price: "~20 AZN" }] },
        { day: 3, activities: [{ name: "Bazar & suvenir", type: "activity", price: "~15 AZN" }] },
      ]},
    ],
  },
  {
    city: "Füzuli",
    lat: 39.6010, lng: 47.1453,
    region: "Qarabağ",
    tagline: "Qarabağa giriş qapılarından biri",
    heroColor: "#C0392B",
    tourismCategory: "karabakh",
    touristPlaces: [
      { name: "Füzuli rayonu panoraması", description: "Dağətəyi düzənlik mənzərələri və foto nöqtələri.", price: "Pulsuz", rating: 4.3, image: "https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=400&h=250&fit=crop" },
      { name: "Tarixi məkanlar guşəsi", description: "Rayonun tarixi barədə qısa məlumat guşələri.", price: "Pulsuz", rating: 4.1, image: "https://images.unsplash.com/photo-1518998053901-5348d3961a04?w=400&h=250&fit=crop" },
      { name: "Təbiət gəzintisi marşrutu", description: "Qısa yürüyüş və piknik üçün uyğun ərazi.", price: "Pulsuz", rating: 4.2, image: "https://images.unsplash.com/photo-1448375240586-882707db888b?w=400&h=250&fit=crop" },
    ],
    restaurants: [
      { name: "Füzuli Kababxanası", cuisine: "Kabab", priceRange: "10–22 AZN", rating: 4.2, image: "https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=400&h=250&fit=crop" },
      { name: "Füzuli Ailə Restoranı", cuisine: "Milli mətbəx", priceRange: "12–25 AZN", rating: 4.1, image: "https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=400&h=250&fit=crop" },
    ],
    hotels: [
      { name: "Füzuli Hotel", priceRange: "45–90 AZN/gecə", rating: 4.0, image: "https://images.unsplash.com/photo-1590490360182-c33d57733427?w=400&h=250&fit=crop" },
      { name: "Füzuli Guest House", priceRange: "20–45 AZN/gecə", rating: 3.9, image: "https://images.unsplash.com/photo-1571003123894-1f0594d2b5d9?w=400&h=250&fit=crop" },
    ],
    plans: [
      { days: 3, price: "5 AZN", dailyPlans: [
        { day: 1, activities: [{ name: "Panorama nöqtələri", type: "activity", price: "Pulsuz" }] },
        { day: 2, activities: [{ name: "Təbiət gəzintisi", type: "activity", price: "Pulsuz" }, { name: "Füzuli Kababxanası", type: "restaurant", price: "~18 AZN" }] },
        { day: 3, activities: [{ name: "Yerli bazar", type: "activity", price: "~10 AZN" }] },
      ]},
    ],
  },
  {
    ...
    lat: 39.63, lng: 46.55,
    region: "Qarabağ",
    tagline: "Dağların qoynunda Laçın",
    heroColor: "#27AE60",
    tourismCategory: "karabakh",
    touristPlaces: [
      { name: "Laçın dağ mənzərələri", description: "Dağ yürüyüşü və təbiət fotoqrafiyası üçün ideal.", price: "Pulsuz", rating: 4.8, image: "https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=400&h=250&fit=crop" },
      { name: "Meşə cığırları", description: "Qısa trekkinq marşrutları, sərin hava.", price: "Pulsuz", rating: 4.6, image: "https://images.unsplash.com/photo-1448375240586-882707db888b?w=400&h=250&fit=crop" },
      { name: "Çay kənarı piknik zonası", description: "Ailəvi piknik və istirahət üçün uyğun məkan.", price: "Pulsuz", rating: 4.4, image: "https://images.unsplash.com/photo-1500534314209-a25ddb2bd429?w=400&h=250&fit=crop" },
    ],
    restaurants: [
      { name: "Laçın Dağ Mətbəxi", cuisine: "Dağ mətbəxi", priceRange: "12–28 AZN", rating: 4.3, image: "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=400&h=250&fit=crop" },
      { name: "Laçın Çay Evi", cuisine: "Kafe/Çay", priceRange: "5–12 AZN", rating: 4.1, image: "https://images.unsplash.com/photo-1466978913421-dad2ebd01d17?w=400&h=250&fit=crop" },
    ],
    hotels: [
      { name: "Laçın Hotel", priceRange: "60–120 AZN/gecə", rating: 4.2, image: "https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?w=400&h=250&fit=crop" },
      { name: "Laçın Guest House", priceRange: "25–55 AZN/gecə", rating: 4.0, image: "https://images.unsplash.com/photo-1571003123894-1f0594d2b5d9?w=400&h=250&fit=crop" },
    ],
    plans: [
      { days: 3, price: "5 AZN", dailyPlans: [
        { day: 1, activities: [{ name: "Dağ mənzərələri", type: "tourist", price: "Pulsuz" }] },
        { day: 2, activities: [{ name: "Meşə cığırı", type: "activity", price: "Pulsuz" }, { name: "Laçın Dağ Mətbəxi", type: "restaurant", price: "~22 AZN" }] },
        { day: 3, activities: [{ name: "Çay kənarı piknik", type: "activity", price: "~10 AZN" }] },
      ]},
    ],
  },
  {
    ...
    lat: 40.10, lng: 46.04,
    region: "Qarabağ",
    tagline: "İstisu və dağ turizmi",
    heroColor: "#16A085",
    tourismCategory: "karabakh",
    touristPlaces: [
      { name: "İstisu (termal bulaqlar)", description: "Termal sular, istirahət və sağlamlıq turizmi üçün məşhur.", price: "10 AZN", rating: 4.7, image: "https://images.unsplash.com/photo-1500534314209-a25ddb2bd429?w=400&h=250&fit=crop" },
      { name: "Dağ yürüyüş marşrutu", description: "Trekkinq və təbiət yürüşləri üçün uyğun istiqamətlər.", price: "Pulsuz", rating: 4.6, image: "https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=400&h=250&fit=crop" },
      { name: "Meşəlik panoramalar", description: "Sıx meşələr və təmiz hava.", price: "Pulsuz", rating: 4.5, image: "https://images.unsplash.com/photo-1448375240586-882707db888b?w=400&h=250&fit=crop" },
    ],
    restaurants: [
      { name: "Kəlbəcər Kababxanası", cuisine: "Kabab/Milli", priceRange: "12–28 AZN", rating: 4.2, image: "https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=400&h=250&fit=crop" },
      { name: "İstisu Kafe", cuisine: "Kafe", priceRange: "6–15 AZN", rating: 4.0, image: "https://images.unsplash.com/photo-1466978913421-dad2ebd01d17?w=400&h=250&fit=crop" },
    ],
    hotels: [
      { name: "Kəlbəcər Hotel", priceRange: "70–140 AZN/gecə", rating: 4.1, image: "https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?w=400&h=250&fit=crop" },
      { name: "İstisu Guest House", priceRange: "30–65 AZN/gecə", rating: 4.0, image: "https://images.unsplash.com/photo-1571003123894-1f0594d2b5d9?w=400&h=250&fit=crop" },
    ],
    plans: [
      { days: 3, price: "5 AZN", dailyPlans: [
        { day: 1, activities: [{ name: "İstisu", type: "tourist", price: "10 AZN" }] },
        { day: 2, activities: [{ name: "Dağ yürüyüşü", type: "activity", price: "Pulsuz" }, { name: "Kəlbəcər Kababxanası", type: "restaurant", price: "~22 AZN" }] },
        { day: 3, activities: [{ name: "Panorama və foto", type: "activity", price: "Pulsuz" }] },
      ]},
    ],
  },
  {
    ...
    lat: 38.91, lng: 46.02,
    region: "Naxçıvan MR",
    tagline: "Bağlar və tarixi küçələr",
    heroColor: "#8E44AD",
    tourismCategory: "nakhchivan",
    touristPlaces: [
      { name: "Ordubad Tarixi Mərkəz", description: "Daş küçələr, tarixi memarlıq və qədim məhəllələr.", price: "Pulsuz", rating: 4.6, image: "https://images.unsplash.com/photo-1519501025264-65ba15a82390?w=400&h=250&fit=crop" },
      { name: "Cümə Məscidi (Ordubad)", description: "Tarixi məscid və ətrafında ənənəvi memarlıq.", price: "Pulsuz", rating: 4.4, image: "https://images.unsplash.com/photo-1585036156171-384164a8c821?w=400&h=250&fit=crop" },
      { name: "Bağlar panoraması", description: "Meyvə bağları və dağ mənzərələri ilə məşhur istiqamət.", price: "Pulsuz", rating: 4.5, image: "https://images.unsplash.com/photo-1448375240586-882707db888b?w=400&h=250&fit=crop" },
    ],
    restaurants: [
      { name: "Ordubad Mətbəxi", cuisine: "Naxçıvan mətbəxi", priceRange: "10–25 AZN", rating: 4.3, image: "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=400&h=250&fit=crop" },
      { name: "Bağ Kafe", cuisine: "Kafe", priceRange: "5–12 AZN", rating: 4.1, image: "https://images.unsplash.com/photo-1466978913421-dad2ebd01d17?w=400&h=250&fit=crop" },
    ],
    hotels: [
      { name: "Ordubad Hotel", priceRange: "45–95 AZN/gecə", rating: 4.1, image: "https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?w=400&h=250&fit=crop" },
      { name: "Ordubad Guest House", priceRange: "20–45 AZN/gecə", rating: 4.0, image: "https://images.unsplash.com/photo-1571003123894-1f0594d2b5d9?w=400&h=250&fit=crop" },
    ],
    plans: [
      { days: 3, price: "5 AZN", dailyPlans: [
        { day: 1, activities: [{ name: "Tarixi mərkəz", type: "tourist", price: "Pulsuz" }] },
        { day: 2, activities: [{ name: "Bağlar panoraması", type: "activity", price: "Pulsuz" }, { name: "Ordubad Mətbəxi", type: "restaurant", price: "~18 AZN" }] },
        { day: 3, activities: [{ name: "Yerinə görə suvenir", type: "activity", price: "~10 AZN" }] },
      ]},
    ],
  },
  {
    ...
    lat: 39.41, lng: 45.57,
    region: "Naxçıvan MR",
    tagline: "Dağlar, təmiz hava, istirahət",
    heroColor: "#2ECC71",
    tourismCategory: "nakhchivan",
    touristPlaces: [
      { name: "Şahbuz dağ mənzərələri", description: "Dağ yürüyüşləri və piknik üçün ideal ərazi.", price: "Pulsuz", rating: 4.6, image: "https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=400&h=250&fit=crop" },
      { name: "Meşə zolaqları", description: "Sakit gəzinti və təbiət müşahidəsi üçün.", price: "Pulsuz", rating: 4.4, image: "https://images.unsplash.com/photo-1448375240586-882707db888b?w=400&h=250&fit=crop" },
      { name: "Şahbuz kənd həyatı", description: "Ənənəvi həyat tərzi və yerli qonaqpərvərlik.", price: "Pulsuz", rating: 4.3, image: "https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=400&h=250&fit=crop" },
    ],
    restaurants: [
      { name: "Şahbuz Kafe", cuisine: "Kafe", priceRange: "5–12 AZN", rating: 4.0, image: "https://images.unsplash.com/photo-1466978913421-dad2ebd01d17?w=400&h=250&fit=crop" },
      { name: "Şahbuz Ailə Mətbəxi", cuisine: "Naxçıvan mətbəxi", priceRange: "10–22 AZN", rating: 4.2, image: "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=400&h=250&fit=crop" },
    ],
    hotels: [
      { name: "Şahbuz Hotel", priceRange: "40–90 AZN/gecə", rating: 4.0, image: "https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?w=400&h=250&fit=crop" },
      { name: "Şahbuz Guest House", priceRange: "20–45 AZN/gecə", rating: 3.9, image: "https://images.unsplash.com/photo-1571003123894-1f0594d2b5d9?w=400&h=250&fit=crop" },
    ],
    plans: [
      { days: 3, price: "5 AZN", dailyPlans: [
        { day: 1, activities: [{ name: "Dağ mənzərələri", type: "tourist", price: "Pulsuz" }] },
        { day: 2, activities: [{ name: "Meşə gəzintisi", type: "activity", price: "Pulsuz" }, { name: "Şahbuz Ailə Mətbəxi", type: "restaurant", price: "~16 AZN" }] },
        { day: 3, activities: [{ name: "Kənd həyatı", type: "activity", price: "Pulsuz" }] },
      ]},
    ],
  },
];
...
// --- Data normalization ---
// Keep plan product prices consistent & realistic across cities.
for (const c of CITIES) {
  for (const p of c.plans) {
    if (p.days === 3) p.price = "19 AZN";
    if (p.days === 5) p.price = "29 AZN";
    if (p.days === 7) p.price = "39 AZN";
    for (const d of p.dailyPlans) {
      for (const a of d.activities) {
        if (a.price === "0 AZN") a.price = "Pulsuz";
      }
    }
  }
}
