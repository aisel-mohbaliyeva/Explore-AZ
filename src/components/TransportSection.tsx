...
export default function TransportSection() {
  ...
  const TRANSPORT_DATA = [
    {
      ...
      address: "📍 28 May meydanı, Bakı Dəmiryol Vağzalı",
      phone: "📞 +994 12 499 47 27",
    ...
    },
    {
      ...
      address: "📍 Həzi Aslanov qəsəbəsi, Bakı",
      phone: "📞 +994 12 525 56 55",
  ...
  const PRICES = [
    { emoji: "🚇", label: "Metro", price: "0.60 AZN" },
    ...
    { emoji: "💳", label: "BakıKart", price: "2.00 AZN" },
  ];
    ...
    <div className="max-w-[1300px] mx-auto px-4 sm:px-6 pb-6 sm:pb-8">
      ...
      <div className="mt-4 sm:mt-5 rounded-2xl border border-border p-4 sm:p-5" style={{ background: "hsl(var(--card))" }}>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-2">
          <span className="font-bold text-xs sm:text-sm">Avis Azerbaijan</span>
        ...
        <div className="text-[11px] sm:text-xs text-muted-foreground">🔗 avis.az</div>
      </div>
