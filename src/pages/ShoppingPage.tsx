...
export default function ShoppingPage() {
  return (
    <div className="max-w-[1100px] mx-auto px-6 pt-8 pb-16">
      <div className="mb-8">
        <h1 className="text-3xl font-extrabold">🛍 Bakıda Alış-veriş</h1>
        <p className="text-muted-foreground text-sm mt-1">Mallar və Marketlər</p>
      </div>
      ...
      <div className="mb-12">
        <div className="flex items-center gap-2 mb-5">
          ...
          <h2 className="font-bold text-lg">🏬 Böyük Mallar</h2>
        </div>
            ...
            <div key={mall.name} className="rounded-2xl overflow-hidden border border-border bg-card hover:-translate-y-1 transition-all hover:shadow-xl group">
              ...
              <div className="p-3.5">
                ...
                <div className="flex items-center gap-1 text-xs text-primary">
                  <TrainFront size={10} /> Metro: {mall.nearestMetro}
                </div>
              </div>
            </div>
          ))}
      ...
      <div>
        <div className="flex items-center gap-2 mb-5">
          ...
          <h2 className="font-bold text-lg">🛒 Marketlər</h2>
          <span className="text-xs text-muted-foreground">Bahalıdan ucuza</span>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
          {BAKU_MARKETS.map((market, i) => {
            ...
            const tierLabels = { premium: "Premium", standard: "Standard", budget: "Büdcə" };
            return (
